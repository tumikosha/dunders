"""Demo app: python -m dunders.windowing.demo
...
from dunders.windowing.demo.contents import (
    FormContent,
    LabelContent,
    ListContent,
    LogContent,
