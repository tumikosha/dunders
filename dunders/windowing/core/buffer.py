...
from dunders.windowing.core.clipboard import system_copy as _copy_to_system
from dunders.windowing.core.clipboard import system_paste as _paste_from_system
